...
public class daoUsuario {
    private static final String SQL_SELECT = "SELECT idUsuarios, Usuario, Password FROM Usuarios";
    private static final String SQL_INSERT = "INSERT INTO Usuarios(Usuario, Password) VALUES(?, ?)";
    private static final String SQL_UPDATE = "UPDATE Usuarios SET Usuario=?, Password=? WHERE idUsuarios = ?";
    ...
    private static final String SQL_SELECT_ID = "SELECT idUsuarios, Usuario, Password FROM Usuarios WHERE idUsuarios = ?";    
